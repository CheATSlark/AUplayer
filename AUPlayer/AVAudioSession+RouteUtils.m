...
- (BOOL)usingWiredMicrophone {
    NSArray *inputs = self.currentRoute.inputs;
    //icrophone on a wired headset.  Headset refers to an accessory that has headphone outputs paired with a microphone.
